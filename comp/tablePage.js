...
const EnhancedTableToolbar = (props) => {
  const { numSelected , handleChangeDense, dense} = props;
...
export default function TablePage() {
  ...
  return (
    <div>
    {isLoading ? <h3>loading data</h3>:<Box sx={{ width: '100%' }}>
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.salesCost}</TableCell>
                      <TableCell align="center">{row.costDate}</TableCell>
